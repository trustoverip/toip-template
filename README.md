The purpose of this repo to collaborate on development of a standard template for Trust Over IP (ToIP) technical specifications. This template will standardize the following elements:
